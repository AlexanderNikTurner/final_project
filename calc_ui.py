...
from PyQt6.QtWidgets import QMainWindow, QLabel, QWidget, QGridLayout, \
    QPushButton, QLineEdit, QComboBox, QVBoxLayout, QTableWidget

from calc_calculation import Battery, Cable, Breaker, Fuse, calculation
from calc_db_work import BatteriesDataBase, CablesDataBase, BreakersDataBase, FusesDataBase
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Кнопки выбора варианта схемы для расчета. По нажатию на экран будет выводиться
    ...
    def renew_layout(self):
        """
        Метод обновляет макет главного окна, выводя на экран выбранную схему, блоки ввода данных,
        ...
        # Выводим на экран схему выбранного варианта. Для выбранного варианта
        # отображаем в нужной последовательности блоки ввода данных для элементов.
        ...
        self.resize(self.chosen_image.width(), self.chosen_image.height())
        self.label_chosen_image.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.layout.addWidget(self.label_chosen_image, 2, 0, 4, 1)

        # Задаем общие для каждого варианта элементы. Для гибкости дальнейшего расширения
        # функционала применяем сеточный макет QGridLayout для каждого поля внутри общего
        # сеточного макета всего окна.
        ...
        self.grid_el4_col1.addWidget(self.box_el4, 1, 0, Qt.AlignmentFlag.AlignTop)
    ...
    def set_battery(self, num_of_element):
        ...
        # Определяем ячейку элемента 1 в столбце 1 "Ввод наименования оборудования".
        # Создаем в ячейке внутреннюю таблицу для возможности расширения функционала в будущем
        ...
        self.grid_bat_col1.addWidget(self.label_bat, 0, 0, Qt.AlignmentFlag.AlignBottom)
        self.input_bat = QLineEdit()
        self.set_label_font(self.input_bat, 10)
        # Введенный текст передаем в столбец 2:
        self.input_bat.textChanged.connect(self.label_bat_name.setText)  # type: ignore
        self.grid_bat_col1.addWidget(self.input_bat, 1, 0, Qt.AlignmentFlag.AlignTop)
        self.layout.addLayout(self.grid_bat_col1, self.bat_num, 1)

        # Определяем ячейку элемента 1 в столбце 2 "Ввод параметров оборудования".
        ...
        self.grid_bat_col2.addWidget(self.label_bat_type, 1, 0, Qt.AlignmentFlag.AlignTop)

        self.input_bat_type = QLineEdit()
        self.set_label_font(self.input_bat_type, 10)
        self.grid_bat_col2.addWidget(self.input_bat_type, 1, 1, Qt.AlignmentFlag.AlignTop)

        self.label_bat_param1 = QLabel('Напряжение, В:')
        self.set_label_font(self.label_bat_param1, 10)
        self.grid_bat_col2.addWidget(self.label_bat_param1, 2, 0, Qt.AlignmentFlag.AlignTop)

        self.input_bat_param1 = QLineEdit()
        self.set_label_font(self.input_bat_param1, 10)
        self.grid_bat_col2.addWidget(self.input_bat_param1, 2, 1, Qt.AlignmentFlag.AlignTop)

        self.label_bat_param2 = QLabel('Сопротивление, Ом:')
        self.set_label_font(self.label_bat_param2, 10)
        self.grid_bat_col2.addWidget(self.label_bat_param2, 3, 0, Qt.AlignmentFlag.AlignTop)

        self.input_bat_param2 = QLineEdit()
        self.set_label_font(self.input_bat_param2, 10)
        self.grid_bat_col2.addWidget(self.input_bat_param2, 3, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.button_bat_to_db.clicked.connect(self.add_element_to_db)  # type: ignore
        ...
        # Определяем ячейку элемента 1 в столбце 3 "Выбор оборудования из базы".
        # Определяем сетку ячейки элемента 1:
        ...
        self.button_bat_from_db.clicked.connect(self.get_element_from_db)  # type: ignore
        ...
        self.button_bat_dont_use_db.clicked.connect(self.undone_from_db)  # type: ignore

        self.grid_bat_col3.addWidget(self.bat_type_from_db, 1, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_bat_col3.addWidget(self.bat_param1_from_db, 2, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_bat_col3.addWidget(self.bat_param2_from_db, 3, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_bat_col3.addWidget(self.button_bat_dont_use_db, 4, 0, Qt.AlignmentFlag.AlignTop)

        # Вносим ячейку в общий макет:
        self.layout.addLayout(self.grid_bat_col3, self.bat_num, 3)

        # Все что далее привести в соответствие с АБ

    def set_cable(self, num_of_element):
        ...
        self.grid_cab_col1.addWidget(self.label_cab, 0, 0, Qt.AlignmentFlag.AlignBottom)
        self.input_cab = QLineEdit()
        self.set_label_font(self.input_cab, 10)
        # Введенный текст передаем в столбец 2:
        self.input_cab.textChanged.connect(self.label_cab_name.setText)  # type: ignore
        self.grid_cab_col1.addWidget(self.input_cab, 1, 0, Qt.AlignmentFlag.AlignTop)
        ...
        self.grid_cab_col2.addWidget(self.label_cab_type, 1, 0, Qt.AlignmentFlag.AlignTop)

        self.input_cab_type = QLineEdit()
        self.set_label_font(self.input_cab_type, 10)
        self.grid_cab_col2.addWidget(self.input_cab_type, 1, 1, Qt.AlignmentFlag.AlignTop)

        self.label_cab_param1 = QLabel('Сечение, мм2:')
        self.set_label_font(self.label_cab_param1, 10)
        self.grid_cab_col2.addWidget(self.label_cab_param1, 2, 0, Qt.AlignmentFlag.AlignTop)

        self.input_cab_param1 = QLineEdit()
        self.set_label_font(self.input_cab_param1, 10)
        self.grid_cab_col2.addWidget(self.input_cab_param1, 2, 1, Qt.AlignmentFlag.AlignTop)

        self.label_cab_param2 = QLabel('Длина, м:')
        self.set_label_font(self.label_cab_param2, 10)
        self.grid_cab_col2.addWidget(self.label_cab_param2, 3, 0, Qt.AlignmentFlag.AlignTop)

        self.input_cab_param2 = QLineEdit()
        self.set_label_font(self.input_cab_param2, 10)
        self.grid_cab_col2.addWidget(self.input_cab_param2, 3, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.button_cab_to_db.clicked.connect(self.add_element_to_db)  # type: ignore
        ...
        self.button_cab_from_db.clicked.connect(self.get_element_from_db)  # type: ignore
        ...
        self.button_cab_dont_use_db.clicked.connect(self.undone_from_db)  # type: ignore

        self.grid_cab_col3.addWidget(self.cab_type_from_db, 1, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_cab_col3.addWidget(self.cab_param1_from_db, 2, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_cab_col3.addWidget(self.cab_param2_from_db, 3, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_cab_col3.addWidget(self.button_cab_dont_use_db, 4, 0, Qt.AlignmentFlag.AlignTop)
    ...
    def set_breaker(self, num_of_element):
        ...
        self.grid_br_col1.addWidget(self.label_br, 0, 0, Qt.AlignmentFlag.AlignBottom)
        self.input_br = QLineEdit()
        self.set_label_font(self.input_br, 10)
        # Введенный текст передаем в столбец 2:
        self.input_br.textChanged.connect(self.label_br_name.setText)  # type: ignore
        self.grid_br_col1.addWidget(self.input_br, 1, 0, Qt.AlignmentFlag.AlignTop)
        ...
        self.grid_br_col2.addWidget(self.label_br_type, 1, 0, Qt.AlignmentFlag.AlignTop)

        self.input_br_type = QLineEdit()
        self.set_label_font(self.input_br_type, 10)
        self.grid_br_col2.addWidget(self.input_br_type, 1, 1, Qt.AlignmentFlag.AlignTop)

        self.label_br_param1 = QLabel('Ток срабатывания, А')
        self.set_label_font(self.label_br_param1, 10)
        self.grid_br_col2.addWidget(self.label_br_param1, 2, 0, Qt.AlignmentFlag.AlignTop)

        self.input_br_param1 = QLineEdit()
        self.set_label_font(self.input_br_param1, 10)
        self.grid_br_col2.addWidget(self.input_br_param1, 2, 1, Qt.AlignmentFlag.AlignTop)

        self.label_br_param2 = QLabel('Время срабатывания, с:')
        self.set_label_font(self.label_br_param2, 10)
        self.grid_br_col2.addWidget(self.label_br_param2, 3, 0, Qt.AlignmentFlag.AlignTop)

        self.input_br_param2 = QLineEdit()
        self.set_label_font(self.input_br_param2, 10)
        self.grid_br_col2.addWidget(self.input_br_param2, 3, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.button_br_to_db.clicked.connect(self.add_element_to_db)  # type: ignore
        ...
        self.button_br_from_db.clicked.connect(self.get_element_from_db)  # type: ignore
        ...
        self.button_br_dont_use_db.clicked.connect(self.undone_from_db)  # type: ignore

        self.grid_br_col3.addWidget(self.br_type_from_db, 1, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_br_col3.addWidget(self.br_param1_from_db, 2, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_br_col3.addWidget(self.br_param2_from_db, 3, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_br_col3.addWidget(self.button_br_dont_use_db, 4, 0, Qt.AlignmentFlag.AlignTop)
    ...
    def set_fuse(self, num_of_element):
        ...
        self.grid_fuse_col1.addWidget(self.label_fuse, 0, 0, Qt.AlignmentFlag.AlignBottom)
        self.input_fuse = QLineEdit()
        self.set_label_font(self.input_fuse, 10)
        # Введенный текст передаем в столбец 2:
        self.input_fuse.textChanged.connect(self.label_fuse_name.setText)  # type: ignore
        self.grid_fuse_col1.addWidget(self.input_fuse, 1, 0, Qt.AlignmentFlag.AlignTop)
        ...
        self.grid_fuse_col2.addWidget(self.label_fuse_type, 1, 0, Qt.AlignmentFlag.AlignTop)

        self.input_fuse_type = QLineEdit()
        self.set_label_font(self.input_fuse_type, 10)
        self.grid_fuse_col2.addWidget(self.input_fuse_type, 1, 1, Qt.AlignmentFlag.AlignTop)

        self.label_fuse_param1 = QLabel('Номинальный ток, А')
        self.set_label_font(self.label_fuse_param1, 10)
        self.grid_fuse_col2.addWidget(self.label_fuse_param1, 2, 0, Qt.AlignmentFlag.AlignTop)

        self.input_fuse_param1 = QLineEdit()
        self.set_label_font(self.input_fuse_param1, 10)
        self.grid_fuse_col2.addWidget(self.input_fuse_param1, 2, 1, Qt.AlignmentFlag.AlignTop)

        self.label_fuse_param2 = QLabel('Номинальное время, с:')
        self.set_label_font(self.label_fuse_param2, 10)
        self.grid_fuse_col2.addWidget(self.label_fuse_param2, 3, 0, Qt.AlignmentFlag.AlignTop)

        self.input_fuse_param2 = QLineEdit()
        self.set_label_font(self.input_fuse_param2, 10)
        self.grid_fuse_col2.addWidget(self.input_fuse_param2, 3, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.button_fuse_to_db.clicked.connect(self.add_element_to_db)  # type: ignore
        ...
        self.button_fuse_from_db = QPushButton('Выбрать предохранитель из базы')
        self.button_fuse_from_db.adjustSize()
        self.button_fuse_from_db.setObjectName('fuse')
        self.button_fuse_from_db.clicked.connect(self.get_element_from_db)  # type: ignore
        ...
        self.button_fuse_dont_use_db = QPushButton('Отменить выбор предохранителя')
        self.button_fuse_dont_use_db.adjustSize()
        self.button_fuse_dont_use_db.setObjectName('fuse')
        self.button_fuse_dont_use_db.clicked.connect(self.undone_from_db)  # type: ignore

        self.grid_fuse_col3.addWidget(self.fuse_type_from_db, 1, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_fuse_col3.addWidget(self.fuse_param1_from_db, 2, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_fuse_col3.addWidget(self.fuse_param2_from_db, 3, 0, Qt.AlignmentFlag.AlignTop)
        self.grid_fuse_col3.addWidget(self.button_fuse_dont_use_db, 4, 0, Qt.AlignmentFlag.AlignTop)
    ...
    def make_calc(self):
        ...
        # С помощью функции check_data_to_use убираем неопределенность какие данные использовать,
        # если пользователь ввел вручную и выбрал из базы. В итоге получаем объект класса с введенными
        # данным.
        ...
        self.bat_to_check = self.check_data_to_use(self.list_of_inputs_bat, self.bat_from_db)
        if self.bat_to_check is False:
            return
        else:
            self.bat_final = Battery(self.final_bat_name, *self.bat_to_check)

        # Аналогичные действия (см. выше для батареи) выполняем для каждого элемента.
        # Для кабеля.
        ...
        self.cab_to_check = self.check_data_to_use(self.list_of_inputs_cab, self.cab_from_db)
        ...
        if self.chosen_scheme == 'Вариант 1':
            ...
            self.br_to_check = self.check_data_to_use(self.list_of_inputs_br, self.br_from_db)
        ...
        if self.chosen_scheme == 'Вариант 2' or self.chosen_scheme == 'Вариант 3':
            ...
            self.fuse_to_check = self.check_data_to_use(self.list_of_inputs_fuse, self.fuse_from_db)
        ...
        Вариант 1: батарея - кабель - автомат
            self.bat_final - self.cab_final - self.br_final
        Вариант 2: батарея - кабель - предохранитель
            self.bat_final - self.cab_final - self.fuse_final
        Вариант 3: батарея - предохранитель - кабель
             self.bat_final - self.fuse_final - self.cab_final
        """
    ...
    # Алгоритм такой:
    # 1) если не выбран вариант из базы и хотя бы одно поле не заполнено, то
    #   функция попросит пользователя все заполнить или выбрать из базы.
    # 2) если выбран элемент из базы, то поля ручного ввода должны быть пустыми.
    # 3) если хотим все задать вручную, то нужно отменить добавление из базы.
    def check_data_to_use(self, list_of_inputs: list, el_from_db: tuple):
        ...
        # Если хотя бы одно поле не заполнено и если не был выбран элемент из базы,
        # то просим пользователя что-то внести:
        if any(v == '' for v in self.list_of_inputs_el) and self.el_from_db is None:
            self.window_extra = WindowAllEmptyParams()
            self.window_extra.show()
            return False

        # Если заполнены поля (даже одно) вручную и был выбран элемент из базы, то
        # сообщим пользователю, что выбрать нужно что-то одно.
        elif any(v != '' for v in self.list_of_inputs_el) and self.el_from_db is not None:
            self.window_extra = WindowRedundantParams()
            self.window_extra.show()
            return False

        # Если был выбран элемент из базы и поля пустые, то окончательно берем тот, что из базы:
        elif self.el_from_db is not None and all(v == '' for v in self.list_of_inputs_el):
            self.final_el_type = self.el_from_db[0]
            self.final_el_param1 = self.el_from_db[1]
            self.final_el_param2 = self.el_from_db[2]
            return [self.final_el_type, self.final_el_param1, self.final_el_param2]

        # Если заполнены все поля вручную и не был выбран элемент из базы,
        # то берем то, что вручную. Проверив предварительно, нет ли ошибок в полях ввода,
        # а также меняем тип числовых параметров с str на float:
        elif self.el_from_db is None and all(v != '' for v in self.list_of_inputs_el):
            self.checked = self.check_user_input_values_and_convert(*self.list_of_inputs_el)
            if self.checked is False:
                return False
            # Если нет ошибок, то возвращаем проверенный список параметров элемента:
            else:
                return self.checked
    ...
    def add_element_to_db(self):
        ...
        self.checked = self.check_user_input_values_and_convert(*self.list_of_inputs)
        if self.checked is False:
            return
        # Если нет ошибок ввода данных, то добавляем элемент в соответствующую базу:
        else:
    ...
    def check_user_input_values_and_convert(self, el_type, el_param1, el_param2):
    ...
    def get_element_from_db(self):
        ...
        # Проверяем откуда вызвали добавление из базы и вызываем новое окно для работы с базой
        self.window_get_from_db = WindowGetFromDataBase(self.needed_el)

        # Из окна работы с базой принимаем сигнал с данными элемента из базы и вызываем функцию
        # для обработки этого сигнала и окончательного внесения из базы.
        self.window_get_from_db.signal_from.connect(self.use_element_from_db)  # type: ignore
        self.window_get_from_db.show()

    def use_element_from_db(self, element):
...
class WindowGetFromDataBase(QWidget):
    ...
    def __init__(self, needed_el):
        ...
        self.table_db.setHorizontalHeaderLabels(["Header 1", "Header 2", "Header 3", "Header 4"])
        for i in range(len(self.all_elements)):
            ...
            self.button_choose_el.clicked.connect(self.get_element)  # type: ignore
    ...
    def get_element(self):
        # Принимаем тип выбранного элемента
        self.chosen_element_type = self.sender().objectName()
        self.element = self.base_to_get.get(self.chosen_element_type)
        # Отправляем сигнал с данными - кортежем, содержащим параметры элемента
        self.signal_from.emit(self.element)  # type: ignore
        self.close()


# Ниже определены вспомогательные окна-виджеты, сообщающие пользователю о результатах его действий
...
class WindowRedundantParams(QWidget):
    def __init__(self):
        ...
        self.layout = QVBoxLayout()
        self.label = QLabel('Выбран и элемент из базы и заполнены поля ввода данных вручную.\n'
                            'Либо отмените выбор элемента, либо сделайте поля параметров пустыми.')
        self.button = QPushButton('Закрыть окно')
        self.layout.addWidget(self.label, Qt.AlignmentFlag.AlignCenter)
        self.layout.addWidget(self.button, Qt.AlignmentFlag.AlignCenter)
        self.setLayout(self.layout)
...
class WindowAllEmptyParams(QWidget):
    def __init__(self):
        ...
        self.setGeometry(300, 300, 150, 150)
        self.layout = QVBoxLayout()
        self.label = QLabel('Проверьте, что заполнены все поля параметров ввода данных\n'
                            'или убедитесь, что выбран элемент из базы.')
        self.button = QPushButton('Закрыть окно')
        self.layout.addWidget(self.label, Qt.AlignmentFlag.AlignCenter)
        self.layout.addWidget(self.button, Qt.AlignmentFlag.AlignCenter)
        self.setLayout(self.layout)
...
class WindowErrInParams(QWidget):
    def __init__(self):
        ...
        self.layout = QVBoxLayout()
        self.label = QLabel('Проверьте, что поле "Тип" не пустое и в других полях нет ошибок\n'
                            '(например, лишние пробелы, знаки, буквы в полях, где требуются числа,\n'
